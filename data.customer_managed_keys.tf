data "azurerm_key_vault_key" "this" {
  count = var.customer_managed_key == null || var.customer_managed_key.direct_values != null ? 0 : 1
...
data "azurerm_user_assigned_identity" "this" {
  count = var.customer_managed_key == null || var.customer_managed_key.user_assigned_identity == null || var.customer_managed_key.direct_values != null ? 0 : 1
